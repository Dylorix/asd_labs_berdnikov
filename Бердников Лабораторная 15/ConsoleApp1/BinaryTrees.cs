namespace ConsoleApp1
{
    internal class BinaryTrees
    {
        ...
        //Прямой обход
        static public void ByPassing(BinaryTrees item, ref string str  )
        {
            if (item != null)
            {
                str += item + ", ";
                ByPassing(item.left,ref str);
                ByPassing(item.right,ref str);
            }
            
        }
        //Центральынй обход
        static public void ByPassing2(BinaryTrees item, ref string str)
        {
            if (item != null)
            {
                ByPassing2(item.left,ref str);
                str += item + ", ";
                ByPassing2(item.right, ref str);
            }
        }
        //Концевой обход
        static public void ByPassing3(BinaryTrees item,ref string str)
        {
            if (item != null)
            {
                ByPassing3(item.right,ref str);
                str += item + ", ";
                ByPassing3(item.left,ref str);
            }
        }
